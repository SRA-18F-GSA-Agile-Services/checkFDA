// It is possible to override anything in the Grails configuration by using a custom settings.groovy file.
// If you want to update your project to use these in development, copy this file to ../UserConfig.groovy
println "Reading custom settings file..."
